...
const controlSearchResults = async function() {
    try {
        ...
        if (!query) (0, _resultsViewDefault.default).renderError();
...
const controlAddRecipe = async function(newRecipeData) {
    try {
        ...
        await _model.uploadRecipe(newRecipeData);
...
const controlAddShoppingList = function() {
    _model.addShoppingList();
    console.log(_model.state.shoppingList);
    console.log("hi");
    (0, _shoppingListViewDefault.default).render(_model.state.shoppingList);
};
const init = function() {
    ...
    (0, _paginationViewDefault.default).addHandlerButtonClick(controlPagination);
    ...
    (0, _recipeViewDefault.default).addHandlerIngredients(controlAddShoppingList);
};
init();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./model":"Y4A21","./views/recipeView":"l60JC","./views/searchView":"9OQAM","./views/resultsView":"cSbZE","./views/paginationView":"6z7bi","./views/bookmarksView":"4Lqzq","./views/addRecipeView":"i6DNj","./config":"k5Hzs","./views/shoppingListView":"eqBFd"}],"gkKU3":[function(require,module,exports) {
...
parcelHelpers.export(exports, "addShoppingList", ()=>addShoppingList);
var _config = require("./config");
...
init();
const uploadRecipe = async function(newRecipeData) {
    try {
        const ingredients = Object.entries(newRecipeData).filter((entry)=>entry[0].startsWith("ingredient") && entry[1] !== "").map((ingredient)=>{
            const ingredientsArray = ingredient[1].split(",").map((element)=>element.trim());
            if (ingredientsArray.length !== 3) throw new Error("Wrong ingredient format. Please try again!");
...
const addShoppingList = function() {
    ...
    const ingredientsArray = [
        ...state.shoppingList,
        ...state.recipe.ingredients.map((ingredient)=>ingredient.description.toLowerCase().replace(/minced|squeezed|needed|need|pieces|warmed|frying|sliced|very|thin|against|the|grain|low|sodium|packed|cnstarch|medium|yellow|to taste| to |1|2|3|4|5|6|7|8|9|0|divided|fresh|quarts|quarter|temperature|room|whole| or |chopped|low-sodium|finely diced|sck|tsp|tsps|tbsp||to |heads| or |dried| cut |cut into| and |fine|finely|tins |tin |yel|tinned|whole|medium|small|low |sodium|as needed|package|packaged|grated|crushed|diced|chopped|to taste|ground|\d+|\b[a-z]\b|[^a-zA-Z0-9\s-]/gi, "").trim())
    ];
    state.shoppingList = ingredientsArray.filter((ingredient, index, array)=>array.indexOf(ingredient) === index);
...
const API_KEY = "0f48adac-80e6-4754-a157-d13c0379372f";
...
var _config = require("./config");
const requestTimeout = function(s) {
...
const AJAX = async function(url, uploadData) {
    try {
        ...
        const res = await Promise.race([
            fetchPromise,
            requestTimeout((0, _config.TIMEOUT_SEC))
        ]);
...
class RecipeView extends (0, _viewDefault.default) {
   ...
   `;
    ...
    <div class="recipe__quantity">${ingredient.quantity ? (0, _fractyDefault.default)(ingredient.quantity).toString() : ""}</div>
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../../img/icons.svg":"cMpiy","fracty":"hJO4d","./View":"5cUXS"}],"cMpiy":[function(require,module,exports) {
module.exports = require("58cd1361d4392481").getBundleURL("hWUTQ") + "icons.21bad73c.svg" + "?" + Date.now();

},{"58cd1361d4392481":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{"../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","regenerator-runtime":"dXNgZ"}],"dXNgZ":[function(require,module,exports) {
/**
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkupButton(currentPage, numPages, type) {
      ...
      <button data-goto=${currentPage - 1} class="btn--inline pagination__btn--prev">
        ...
        if (type === "next" && currentPage < numPages) return `
...
},{"./View":"5cUXS","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eqBFd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
class ShoppingListView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
      ...
      `;
        return `<ul class='shopping-list__list'>${this._data.map((ingredient)=>`<li>${ingredient} <button class="shopping-list__delete-btn" type="button">X</button></li>`).join("")}</ul>`;
    }
...
},{"./View":"5cUXS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./previewView":"1FDQ6"}]},["d8XZh","aenu9"], "aenu9", "parcelRequire7e89")
